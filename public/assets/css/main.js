...
export default StyleSheet.create({
    ...
    "body": {
        ...
        "background": "#2e3842",
        "color": "#fff",
        "fontFamily": "\"Noto Sans KR\", Helvetica, sans-serif",
        "fontWeight": "400",
        "letterSpacing": 0.075
    },
    "div": {
    ...
    "banner more": {
        ...
        "MozTransitionDelay": "1.5s",
        "WebkitTransitionDelay": "1.5s",
        "MsTransitionDelay": "1.5s",
    ...
    "banner:after": {
        ...
        "MsPointerEvents": "none",
        "pointerEvents": "none",
        "MozTransition": "opacity 1.5s ease-in-out",
        "WebkitTransition": "opacity 1.5s ease-in-out",
        "MsTransition": "opacity 1.5s ease-in-out",
    ...
    "bodyis-loading banner logo:before": {
        "width": 0
    },
    "bodyis-loading banner logo:after": {
        "width": 0
    },
    ...
    "bodylanding page-wrapper": {
        "backgroundImage": "linear-gradient(top, rgba(0,0,0,0.25), rgba(0,0,0,0.25)), url(\"../../images/banner.jpg\")",
